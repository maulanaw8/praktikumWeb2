...
//Tambah
function insertDataMember($nama_member, $nomor_member, $password, $alamat, $tgl_mendaftar, $tgl_terakhir_bayar)
{
    $sql = "INSERT INTO `member` (`nama_member`, `nomor_member`, `password`, `alamat`, `tgl_mendaftar`, `tgl_terakhir_bayar`) VALUES (:nama_member,:nomor_member,:password, :alamat,:tgl_mendaftar,:tgl_terakhir_bayar)";
...
//Update
function updateMember($id_member, $nama_member, $nomor_member, $password, $alamat, $tgl_mendaftar, $tgl_terakhir_bayar)
{
    $pdo_statement = koneksi()->prepare(
        "UPDATE member SET nama_member='" . $nama_member . "', nomor_member='" . $nomor_member . "', password='" . $password . "', alamat='" . $alamat . "', tgl_mendaftar='" . $tgl_mendaftar . "', tgl_terakhir_bayar='" . $tgl_terakhir_bayar . "' where id_member=" . $id_member
    );
